...
The Android client SHALL permit cleartext HTTP traffic to `192.168.0.15` and SHALL NOT enable cleartext traffic globally for other destinations.

#### Scenario: Connect to the development backend
- **WHEN** the client requests `http://192.168.0.15:8080/`
