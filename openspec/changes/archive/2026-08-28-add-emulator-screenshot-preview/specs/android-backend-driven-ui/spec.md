...
The Android client SHALL treat missing required fields, invalid field types, and node types other than `column`, `row`, `text`, `button`, `input`, or `image` as parse failures.
